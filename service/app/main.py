...
from core.models.Railway_attrition_record import RailwayAttritionRecord

# Define global variables
SERVICE_NAME = "Railway Attrition API"
MODEL_ARTIFACT_PATH = "./Railway_attrition_model"
...
@app.post("/predict")
async def predict(data: List[RailwayAttritionRecord]):
    """
